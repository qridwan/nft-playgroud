...
const About = () => {
  ...
  return (
    <main className="md:max-w-8xl px-10  md:px-20 py-10 md:py-20 grid grid-cols-1  md:grid-cols-4 gap-4 my-10  bg-light/30">
      <section className="col-span-2 text-h4 my-2 md:text-h3 font-caps md:w-3/4 lg:w-3/5 uppercase">
        The amazing NFT art of the world here
      </section>
      {abouts.map((obj) => (
        <section key={obj.title} className="col-span-1 space-x-3 my-4 md:my-0">
